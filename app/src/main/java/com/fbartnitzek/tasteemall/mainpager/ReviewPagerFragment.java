...
public class ReviewPagerFragment extends BasePagerFragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mReviewAdapter = new ReviewAdapter((contentUri, vh) -> {
        ...
        mReviewsHeading = mRootView.findViewById(R.id.heading_entities);
    ...
    public void restartLoader() {
        ...
        LoaderManager.getInstance(this).restartLoader(REVIEW_LOADER_ID, null, this);
    }
...
//        Log.v(LOG_TAG, "onCreateLoader, hashCode=" + this.hashCode() + ", " + "id = [" + id + "], args = [" + args + "]");
        if (id == REVIEW_LOADER_ID) {
            if (this.jsonUri == null) { // explicitly null by activity before (and set searchPattern)
