...
public class DrinkPagerFragment extends BasePagerFragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mDrinkAdapter = new DrinkAdapter((drinkName, contentUri, vh) -> {
            Bundle bundle;
        ...
        mDrinksHeading = mRootView.findViewById(R.id.heading_entities);
    ...
    public void restartLoader() {
        LoaderManager.getInstance(this).restartLoader(DRINK_LOADER_ID, null, this);
    }
